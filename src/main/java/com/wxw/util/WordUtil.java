...
public class WordUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        header.put("type", "jpg");
        header.put("content", "C:\\Users\\wxw\\Desktop\\photo.jpg");//图片路径
        param.put("${aaa}",header);
        XWPFDocument doc = WordUtil.generateWord(param, "C:\\Users\\wxw\\Desktop\\33.docx");
        FileOutputStream fopts = new FileOutputStream("C:\\Users\\wxw\\Desktop\\44.docx");
        doc.write(fopts);
        fopts.close();
    }
