...
public class blog {
    public static void main(String[] args) throws Exception {
        //测试添加图片
        String sourceFile="C:\\Users\\wxw\\Desktop\\33.docx";
        String targetFile="C:\\Users\\wxw\\Desktop\\22.docx";
...
//			}
            ...
            for(int i = 0; i<stamps.size() && i<para.getRuns().size(); i++) {
                try {
                    XWPFRun run = para.getRuns().get(i);
                    FileInputStream is = new FileInputStream("C:\\Users\\wxw\\Desktop\\photo.jpg");
                    run.addPicture(is, XWPFDocument.PICTURE_TYPE_JPEG, "C:\\Users\\wxw\\Desktop\\photo.jpg", Units.toEMU(100), Units.toEMU(100));
                    is.close();
                    run.setText("  ",0);
                } catch (Exception e) {
