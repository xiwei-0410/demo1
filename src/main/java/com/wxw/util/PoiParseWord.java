...
public class PoiParseWord {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            //模板文件位置
            String path="C:\\Users\\wxw\\Desktop\\11.docx";
            //生成文件位置
            String fileName= new String("C:\\Users\\wxw\\Desktop\\22.docx".getBytes("UTF-8"),"iso-8859-1");
            getWordFile(path,list,fileName);
            //System.out.println(doesItExistStr("评委签字：","C:\\\\Users\\\\wxw\\\\Desktop\\\\11.docx"));

//            System.out.println(saveUrlAs("http://fileimg.makalu.cc/990c06c1-9539-412f-aebc-21a1b8dd7e90-中铁一局集团数控钢筋加工设备集采评标报告.docx","C:\\Users\\wxw\\Desktop\\","POST",".docx"));
        }catch(Exception e){
            e.printStackTrace();
        }
    }
